...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startstopLayout = findViewById(R.id.startStopLayout);
        ...
        executeLine = findViewById(R.id.executeLine);
    ...
    protected void doStart() {
        ...
        Intent serviceIntent = new Intent(this, CuberiteService.class);
    ...
    protected void onPause() {
        ...
        LocalBroadcastManager.getInstance(this).unregisterReceiver(updateLog);
        LocalBroadcastManager.getInstance(this).unregisterReceiver(showStartupError);
        LocalBroadcastManager.getInstance(this).unregisterReceiver(serverStopped);
        super.onPause();
    }
    ...
    protected void onResume() {
        super.onResume();
        LocalBroadcastManager.getInstance(this).registerReceiver(updateLog, new IntentFilter("updateLog"));
        LocalBroadcastManager.getInstance(this).registerReceiver(showStartupError, new IntentFilter("showStartupError"));
        LocalBroadcastManager.getInstance(this).registerReceiver(serverStopped, new IntentFilter("serverStopped"));

        // Fill log view and update button state when app is opened
        LocalBroadcastManager.getInstance(this).sendBroadcast(new Intent("updateLog"));
        checkState();
    }
}
